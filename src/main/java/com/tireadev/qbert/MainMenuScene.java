...
public class MainMenuScene extends Scene {
    ...
    public void onUpdate(float deltaTime) {
        ...
        drawText("Play", (16 * 7) * scale, (16 * 7) * scale, chars, 44, scale, true);
        drawText("Quit", (16 * 7) * scale, (16 * 8) * scale, chars, 44, scale, true);
        drawImage((5 * 16) * scale, (16 * 7) * scale, bertHimself, scale);
